                ...
                <table className="w-full text-sm">
                  <thead>
                    <tr className="border-b border-dark-700">
                      <th className="text-left py-3 px-4 text-dark-400 font-medium">Skill</th>
                      <th className="text-left py-3 px-4 text-dark-400 font-medium">Category</th>
                      <th className="text-left py-3 px-4 text-dark-400 font-medium">Importance</th>
                      <th className="text-center py-3 px-4 text-dark-400 font-medium">In Resume</th>
                    </tr>
                  </thead>
                  <tbody>
